// ABOUTME: mDNS/Bonjour discovery for finding Resonate servers on the local network
// ABOUTME: Uses Network framework NWBrowser to discover _resonate-server._tcp services

import Foundation
import Network

/// Discovers Resonate servers on the local network via mDNS
public actor ServerDiscovery {
    ...
    public func startDiscovery() {
        ...
        // Create browser for _resonate-server._tcp service
